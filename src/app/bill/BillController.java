...
import app.customer.AccountsEntity;
import app.customer.BillEntity;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		searchField.textProperty().addListener((observable, oldValue, newValue) -> {
			filteredData.setPredicate(customerProp -> {
				...
				if (customerProp.getCustomerName().toLowerCase().contains(lowerCaseFilter)) {
					return true;
				} else if (customerProp.getCustomerAddress().toLowerCase().contains(lowerCaseFilter)) {
					return true;
				}
		...
		ediCustomerBtn.setOnAction((e) -> {
			...
			customerNameField.setText(ce.getCustomerName());
			customerAddressField.setText(ce.getCustomerAddress());
			customerDialog.setTransitionType(DialogTransition.CENTER);
			customerDialog.show();
