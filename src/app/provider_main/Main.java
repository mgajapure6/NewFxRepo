...
//        drawer.setPopStylesheet(getClass().getResource("/com/gn/theme/css/popover.css"));
	...
	private void addSubPop() throws Exception {
		popup.setContentNode(FXMLLoader.load(getClass().getResource("/app/provider_main/Popover.fxml")));
...
//		}
	...
	private void loadContentPopup() {
		try {
			popContent = FXMLLoader.load(getClass().getResource("/app/provider_main/Config.fxml"));
...
//	}
	...
	private void productView() throws IOException {
		...
		body.setContent(FXMLLoader.load(getClass().getResource("/app/provider_main/ProviderProductView.fxml")));
...
//	}
	...
	private void billView() throws IOException {
		title.setText("Order Received");
		body.setContent(FXMLLoader.load(getClass().getResource("/app/provider_main/ProviderBillView.fxml")));
	}
...
//	}
	...
	private void openMessages() {
		if (!pop.isShowing()) {
			...
			listView.getStylesheets()
					.add(getClass().getResource("/com/gn/theme/css/custom-scroll.css").toExternalForm());
	...
	private void openNotification() {
		if (!pop.isShowing()) {
			...
			avatar3.setImage(
					new Image(getClass().getResource("/com/gn/module/media/notification-35.png").toExternalForm()));
